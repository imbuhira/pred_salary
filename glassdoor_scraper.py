...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    # Uncomment the line below if you'd like to navigate to jobs in Atlanta
    # url = 'https://www.glassdoor.com/Job/jobs.htm?sc.keyword=' + keyword + '&locT=C&locId=1155583&locKeyword=Atlanta,%20GA&jobType=all&fromAge=-1&minSalary=0&includeNoSalaryJobs=true&radius=100&cityId=-1&minRating=0.0&industryId=-1&sgocId=-1&seniorityType=all&companyId=-1&employerSizes=0&applicationType=0&remoteWorkType=0'
    driver.get(url)
    jobs = []
    ...
    while len(jobs) < num_jobs:  # If true, should be still looking for new jobs.
        ...
        for job_button in job_buttons:
            ...
            if len(jobs) >= num_jobs:
                break
            # Make sure the item is in view before clicking
            ...
            try:
                ...
                try:
                    ...
                    #    <span class="value">Atlanta, GA</span>
                    # </div>
